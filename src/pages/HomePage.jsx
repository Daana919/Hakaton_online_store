...
const HomePage = () => {
  ...
  return (
    <div className="background">
      ...
      <div
        className="homepage"
        style={{ width: "100%", background: "#fbf5eb" }}
      >
        <div className="homepage_top">
          <div className="homepage_top_content">
            <h3 className="homepage_top_title">
              Craft your moments, shape your life
            </h3>
          </div>
        </div>
        ...
        <div className="header_top">
          <div className="header_top_content">
            ...
            <p>
              Discover the perfect blend of luxury and functionality with our
              range of premium watches, crafted with the highest standards of
        ...
        <div className="collection">
          <div className="collection_content">
            <span className="gold">
              TimeSculpt watches are crafted with scrupulous attention to
              detail.
            </span>
            <p className="collection_text">
              Explore the TimeSculpt collection of prestigious, high-precision
              timepieces. TimeSculpt offers a wide assortment of Classic and
