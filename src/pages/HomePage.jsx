...
const HomePage = () => {
	...
	return (
		<div className='background'>
			<div class='fullscreen-bg' style={{ background: "black" }}>
				<video preload='auto' loop autoplay playsInline controls class='fullscreen-bg__video'>
					<source style={{ opacity: "40%" }} src='https://content.rolex.com/dam/watches/hubs/all-watches/videos/hub-collection-watches-cover.mp4' type='video/mp4' />
				</video>
			</div>
			<div className='homepage' style={{ width: "100%", background: "white" }}>
				<div className='homepage_top'>
					<div className='homepage_top_content'>
						<h3 className='homepage_top_title'>DATEJUST-Date with destiny</h3>
						<p classname='homepage_top_p'> </p>
					</div>
				</div>
				...
				<div className='collection'>
					<div className='collection_content'>
						<span className='gold'>Timesculp watches are crafted with scrupulous attention to detail.</span>
						<p className='collection_text'>
							Explore the TimeSculp collection of prestigious, high-precision timepieces. Timesculp offers a wide assortment of Classic and Professional watch models to suit any wrist. Discover the broad selection of Rolex watches to find a perfect combination of style and functionality.
						</p>
					</div>
				</div>
			...
			<div className='present'>
				...
				<div className='present_content'>
					...
					<button className='present_content_btn' onClick={() => navigate("/products")}>
						Find the gift
					</button>
				</div>
			</div>
